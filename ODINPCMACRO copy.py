...
def left_prisongate(x1, x2, y1, y2):
    ...
    while True:
        ...
        if rgb1 == color1:
            ...
            print(time.ctime())
            time.sleep(random.uniform(2.5, 3.5))
            pag.click(random.uniform(20, 30), random.uniform(260, 270), 1, random.uniform(0.3, 0.6))
            # 던전 나가기 20, 260 / 30, 270
            time.sleep(random.uniform(2.5, 3.5))
            pag.click(random.uniform(490, 605), random.uniform(600, 620), 1, random.uniform(0.3, 0.6))
            # 나가기 490, 600 / 605, 620       
            time.sleep(random.uniform(15.11, 16.22))
            pag.click(random.uniform(760, 785), random.uniform(895,920), 1, random.uniform(0.3, 0.6))
            # 소모품 상인
            ...
            # 이동
            time.sleep(random.uniform(2.5, 3.5))
            pag.click(random.uniform(917, 930), random.uniform(971, 1007), 1, random.uniform(0.3, 0.6))
            # 파티 917, 170 / 930, 185
            time.sleep(random.uniform(2.5, 3.5))
            pag.click(random.uniform(880, 900), random.uniform(295, 310), 1, random.uniform(0.3, 0.6))
...
def oneclickgate():
    ...
    left_returntotown()
    left_itemequip()
    left_buy_potion(21, 280, 609, 655)
    left_dailygate(349, 625, 377, 530, 23, 282, 155, 185)
    left_gateend(349, 625, 377, 530, 23, 282, 155, 185)
    left_buy_potion(30, 280, 535, 575)
    left_dailygate(661, 917, 375, 530, 23, 285, 99, 130)
    left_gateend(349, 625, 377, 530, 23, 285, 99, 130)
    ...
    left_itemequip()
    left_buy_potion(21, 280, 609, 655)
    left_dailygate(349, 625, 377, 530, 23, 285, 99, 130)
    left_gateend(349, 625, 377, 530, 23, 285, 99, 130)
    left_buy_potion(21, 280, 609, 655)
    left_dailygate(661, 917, 375, 530, 23, 285, 99, 130)
    left_gateend(349, 625, 377, 530, 23, 285, 99, 130)
...
schedule.every().day.at("04:30:00").do(oneclickgate)
